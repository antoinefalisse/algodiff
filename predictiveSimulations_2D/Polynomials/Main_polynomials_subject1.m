...
if extractData == 1
    ...
    MA.hip.flex = importdata([path_resultsMA,...
        'subject01_MuscleAnalysis_MomentArm_hip_flexion_r.sto']);
    % knee flexion r 
    MA.knee.flex = importdata([path_resultsMA,...
        'subject01_MuscleAnalysis_MomentArm_knee_angle_r.sto']);
    % ankle r
    MA.ankle.flex = importdata([path_resultsMA,...
        'subject01_MuscleAnalysis_MomentArm_ankle_angle_r.sto']);
    % Organize MuscleData
    ...
    load('MuscleData_subject1.mat','MuscleData')
end
