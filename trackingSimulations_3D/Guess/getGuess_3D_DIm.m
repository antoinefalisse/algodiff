...
% the joint and muscle variables but set constant values to the arm variables.
%
% Author: Antoine Falisse
% Date: 12/19/2018
% 
function guess = getGuess_3D_DIm(Qs,mvar,nq,N,jointi,scaling)
...
guess.a = mvar.a;
guess.vA = mvar.vA;
guess.FTtilde = mvar.FTtilde;
guess.dFTtilde = mvar.dFTtilde;
